...
def custom_400_error(request, exception=None, template_name='errors/400.html'):
...
def custom_403_error(request, exception=None, template_name='errors/403.html'):
...
def custom_404_error(request, exception=None, template_name='errors/404.html'):
    context = {'request_path': request.path, 'exception': exception_message(exception)}
    return render(request, template_name=template_name, context=context, status=404)


def custom_500_error(request, template_name='errors/500.html'):
